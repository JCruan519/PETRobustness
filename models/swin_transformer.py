...
default_cfgs = {
    ...
    'swin_small_patch4_window7_224_22k': _cfg(
...
@register_model
def swin_small_patch4_window7_224_22k(pretrained=False, **kwargs):
    """ Swin-S @ 224x224, trained ImageNet-22k
    """
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 18, 2), num_heads=(3, 6, 12, 24), **kwargs)
    return _create_swin_transformer('swin_small_patch4_window7_224_22k', pretrained=pretrained, **model_kwargs)
