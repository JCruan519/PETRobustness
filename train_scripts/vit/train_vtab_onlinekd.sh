...
model_t='vit_large_patch16_224_in21k'

NODE_NUM=2
DATA_ROOT_PATH=/media/ruanjiacheng/新加卷/ecodes/Prompt/data/vtab-1k
exp_tag=''
CSV_ROOT_PATH=/media/ruanjiacheng/新加卷/ecodes/Prompt/CV/GIST_ALL/outputs/${t_mode}/${exp_tag}/
CSV_PATH=${CSV_ROOT_PATH}/all_csv.csv
OUTPUT_PATH=/media/ruanjiacheng/新加卷/ecodes/Prompt/CV/GIST_ALL/outputs/
master_port=12447
train_py=/media/ruanjiacheng/新加卷/ecodes/Prompt/CV/GIST_ALL/train_onlinekd.py
