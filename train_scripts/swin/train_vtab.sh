t_mode='gist_adapter' # gist_adapter
model='swin_base_patch4_window7_224_in22k'
NODE_NUM=2
DATA_ROOT_PATH=/mnt/petrelfs/ruanjiacheng/CODES/CV/DATA/vtab-1k
exp_tag=''
CSV_ROOT_PATH=/mnt/petrelfs/ruanjiacheng/CODES/CV/PEFT/GISTv2/outputs/${t_mode}/${exp_tag}/
CSV_PATH=${CSV_ROOT_PATH}/all_csv.csv
OUTPUT_PATH=/mnt/petrelfs/ruanjiacheng/CODES/CV/PEFT/GISTv2/outputs/
master_port=$((10000 + $RANDOM % 20000))
train_py=/mnt/petrelfs/ruanjiacheng/CODES/CV/PEFT/GISTv2/train.py
